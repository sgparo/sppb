              ...
              onClick={() => {
                if (onSaveQuote) {
                  const quoteData = {
                    ...
                    Material_Cost: ((calculations.shinglePrice + calculations.underlaymentPrice) * calculations.squares).toFixed(2),
                    Labor_Cost: calculations.baseMaterialCost.toFixed(2),
                    Disposal_Cost: 0,
                    Permit_Cost: 0,
                    Other_Costs: calculations.pitchCostTotal.toFixed(2),
                    Subtotal: (calculations.totalCost - calculations.solarTotal).toFixed(2),
